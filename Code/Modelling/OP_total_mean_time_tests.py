...
#Welch test
values_per_group = [(col_name.year, col.dropna()) for col_name, col in dfg.groupby(pd.Grouper(freq="Y"))['TotalKg']]
...
results_tukey = pairwise_tukeyhsd(dfg['TotalKg'], dfg['Year'], alpha = 0.05)
